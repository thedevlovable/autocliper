...
const SOCIALS = [
  ...
  {
    label: 'AutoCliper on Instagram', href: 'https://www.instagram.com/autocliper.pro?igsh=MTJheXVvZGYwM2toZg==',
  ...
  {
    label: 'AutoCliper on TikTok', href: 'https://www.tiktok.com/@autocliperofficial?lang=en-GB',
