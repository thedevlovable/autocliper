...
const SOCIALS = [
  { label: 'AutoCliper on Instagram', href: 'https://www.instagram.com/autocliper.pro?igsh=MTJheXVvZGYwM2toZg==', path: IG_PATH },
  { label: 'AutoCliper on TikTok',    href: 'https://www.tiktok.com/@autocliperofficial?lang=en-GB',              path: TT_PATH },
  { label: 'AutoCliper on Instagram (2)', href: 'https://www.instagram.com/autocliper.pro?igsh=MTJheXVvZGYwM2toZg==', path: IG_PATH },
  { label: 'AutoCliper on TikTok (2)',    href: 'https://www.tiktok.com/@autocliperofficial?lang=en-GB',              path: TT_PATH },
];
